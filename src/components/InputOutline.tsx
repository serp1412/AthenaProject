  ...
  (props, ref) => {
    ...
    return (
      <View style={{flexShrink: 1, flexDirection: 'column'}}>
        <Animated.View onLayout={handlePlaceholderLayout}>
          <Animated.Text style={[styles.placeholderText, {marginBottom: 5}]}>
            {placeholder}
          </Animated.Text>
        </Animated.View>
        <Animated.View
        ...
        {errorState() && <Text style={[styles.errorText]}>{error}</Text>}
      </View>
    );
  },
);
